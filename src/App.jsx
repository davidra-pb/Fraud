...
const TitleSlide = () => (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-8 bg-gradient-to-br from-sky-50 to-white">
      <div className="w-32 h-32 bg-sky-500 rounded-[2.5rem] flex items-center justify-center shadow-2xl shadow-sky-200 print:border print:border-slate-200">
    ...
    return (
        <div className="h-full flex flex-col justify-center px-16 animate-fadeIn overflow-hidden">
            ...
            <div className="flex-grow flex flex-col items-center justify-start pt-2">
                ...
                {/* Layer 4 (Core) */}
                <div className="w-[70%] bg-white text-slate-800 p-6 rounded-2xl text-center border-2 border-emerald-500 shadow-lg relative z-40 flex items-center justify-between px-10 anim-shield mt-2 print:border-slate-300">
...
const FraudStrategySlide = () => (
    <div className="h-full flex flex-col justify-center px-16 animate-fadeIn overflow-hidden">
       ...
       {/* Actions Grid */}
       <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-grow max-h-[35vh]">
          {/* Preventive */}
          <div className="bg-white p-6 rounded-[2rem] shadow-md border border-slate-100 flex flex-col print:border-slate-300">
              ...
              <ul className="space-y-4 flex-grow pr-2">
...
const TrendsSlide = () => (
  <div className="h-full flex flex-col justify-center px-16 animate-fadeIn overflow-hidden">
     ...
     <div className="grid grid-cols-2 gap-12 flex-grow max-h-[55vh]">
        <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl transition-all relative flex flex-col justify-between h-full print:border-slate-300">
            <div>
...
const ChartSlide = () => {
    ...
    return (
    <div className="h-full flex flex-col px-8 overflow-hidden">
    ...
    <div className="h-full flex flex-col justify-center px-16 animate-fadeIn overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-8 flex-grow max-h-[50vh] min-h-0">
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl transition-all group flex flex-col h-full print:border-slate-300">
                ...
                <ul className="text-slate-600 text-lg leading-relaxed space-y-4 flex-grow">
...
const FutureOutlookSlide = () => (
    <div className="h-full flex flex-col justify-center px-16 animate-fadeIn overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow max-h-[65vh]">
            ...
            <div className="bg-white border border-slate-100 p-8 rounded-[2rem] shadow-lg transform hover:scale-105 transition duration-300 flex flex-col print:border-slate-300">
...
const ThankYouSlide = () => (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-10 animate-fadeIn bg-gradient-to-tl from-sky-50 to-white">
        <div className="w-32 h-32 bg-sky-100 rounded-full flex items-center justify-center mb-4 shadow-sm print:border print:border-slate-300"><ShieldCheck className="w-16 h-16 text-sky-500" /></div>
